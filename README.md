...
This project analyzes and forecasts traffic accident trends in Mexico using historical data from the ATUS dataset (1997–2024). The goal is to identify temporal patterns such as trend and seasonality, and to generate accurate forecasts for future periods using time series modeling techniques.

# Objectives
Analyze historical traffic accident data to identify patterns and anomalies
Model trend and seasonality using time series methods
Generate forecasts for future periods (2025)
